---
title: "Supplementary - Normalization & Highly Variable Gene Selection"
author: "CDN team"
date: last-modified
...
```{r}
se <- readRDS(file = "../data/Covid_Flu_Seurat_Object.rds")
```
...
Let's start by taking a look at the `sequencing depth` of our cells. By library depth we refer to the number of transcripts (UMIs) detected in each cell
```{r}
